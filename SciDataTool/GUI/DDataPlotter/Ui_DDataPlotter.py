...
class Ui_DDataPlotter(object):
    def setupUi(self, DDataPlotter):
        ...
        self.w_plot_manager.setSizePolicy(sizePolicy2)
        ...
        self.is_auto_refresh.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.b_refresh.sizePolicy().hasHeightForWidth())
        self.b_refresh.setSizePolicy(sizePolicy3)
