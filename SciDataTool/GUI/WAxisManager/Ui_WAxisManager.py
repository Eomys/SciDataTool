...
class Ui_WAxisManager(object):
    def setupUi(self, WAxisManager):
        ...
        self.g_data_extract.setGeometry(QRect(10, 180, 280, 180))
        ...
        self.g_data_extract.setMinimumSize(QSize(0, 180))
        ...
        self.verticalLayoutWidget.setGeometry(QRect(10, 20, 261, 151))
        ...
        self.g_axes.setGeometry(QRect(11, 11, 280, 160))
        ...
        self.g_axes.setMinimumSize(QSize(0, 160))
        self.g_axes.setMaximumSize(QSize(296, 160))
        self.layoutWidget = QWidget(self.g_axes)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(11, 21, 261, 131))
