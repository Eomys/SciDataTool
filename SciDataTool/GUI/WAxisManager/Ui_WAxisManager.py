...
class Ui_WAxisManager(object):
    def setupUi(self, WAxisManager):
        ...
        self.g_data_extract.setGeometry(QRect(11, 138, 296, 341))
        ...
        self.g_axes.setGeometry(QRect(11, 11, 296, 120))
        ...
        self.layoutWidget.setGeometry(QRect(10, 20, 281, 91))
