...
class Ui_WVectorSelector(object):
    def setupUi(self, WVectorSelector):
        ...
        self.layoutWidget = QWidget(WVectorSelector)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(10, 10, 261, 51))
        self.gridLayout = QGridLayout(self.layoutWidget)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.in_component = QLabel(self.layoutWidget)
        self.in_component.setObjectName(u"in_component")

        self.gridLayout.addWidget(self.in_component, 0, 0, 1, 1)

        self.c_component = QComboBox(self.layoutWidget)
