# -*- coding: utf-8 -*-
"""File generated according to pyleecan/Generator/ClassesRef/Output/DataLinspace.csv
...
try:
    from pyleecan.Methods.Output.DataLinspace.get_values import get_values
