...
class TestGUI(object):
    ...
    def check_autorefresh_update(self):
        ...
        self.UI.w_plot_manager.c_auto_refresh.setChecked(True)
        assert self.UI.w_plot_manager.is_auto_refresh == True

        self.UI.w_plot_manager.c_auto_refresh.setChecked(False)
        assert self.UI.w_plot_manager.is_auto_refresh == False
    ...
    def check_signal(self):
        ...
        assert self.UI.w_plot_manager.is_plot_updated == True
        ...
        assert self.UI.w_plot_manager.is_plot_updated == False
